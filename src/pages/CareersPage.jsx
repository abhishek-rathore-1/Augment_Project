  ...
  return (
    <>
      <PageHero
        ...
        description="We value ownership, communication, and technical curiosity. If that sounds like your working style, we would love to hear from you."
      ...
      <section className="section-space bg-slate-950 text-white">
        <div className="site-shell">
          <SectionHeading
            ...
            description="If one of these roles fits your strengths, you can apply directly through the role page."
            align="center"
          />
